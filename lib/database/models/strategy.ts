...
export interface IStrategy {
  ...
  likeCount: number; // Add likeCount field
  shareCount: number; // Add shareCount field
  copyCount: number; // Add copyCount field
}
...
const StrategySchema = new Schema<IStrategy>({
  ...
  likeCount: { type: Number, required: true, default: 0 }, // Add likeCount field
  shareCount: { type: Number, required: true, default: 0 }, // Add shareCount field
  copyCount: { type: Number, required: true, default: 0 }, // Add copyCount field
});
